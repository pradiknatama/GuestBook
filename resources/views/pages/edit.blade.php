            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <form action="/guest/{{ $guest->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class=" row mb-3">
                                    <label for="staticEmail" class="col-sm-2 col-form-label">First Name</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="fname" value="{{ $guest->f_name }}">
                                    </div>
                                </div>
                                @error('fname')
                                ...
                                <div class=" row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="lname" value="{{ $guest->l_name }}">
                                    </div>
                                </div>
                                @error('lname')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                ...
                                <div class=" row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="organization" value="{{ $guest->organization }}">
                                    </div>
                                </div>
                                @error('organization')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="provinsi" name="province"
                                            ...
                                            @forelse ($provinsi as $item)
                                                @if ($item->kode== $guest->prov->kode)
                                                    <option value="{{ $guest->prov->kode }}" selected>{{ $guest->prov->nama  }}</option>
                                                @else
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" name="city" id="kota"
                                            aria-label="Default select example" required>
                                            <option value="{{ $guest->kota->kode }}">{{ $guest->kota->nama }}</option>
                                        </select>
                                    </div>
                                </div>
                                @error('city')
